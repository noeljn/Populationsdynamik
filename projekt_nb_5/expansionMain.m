function expansionMain(dataT3)
    ...
    %Plots out how the crop is dependent on tau
    figure(5)
    ...
    %Copying the graph with data from t = 0 to 3
    f1 = figure(6);
    ...
    %The for loop calculates the populations for each tau in tauvec and
    %Plots them into correct graph
    for n = 0:1
        for i = 1:4
        ...
        %Corrects the title for each figure
    ...
    %Calculates the populations when harvesting at optimumtau
    data = harvesting(dataT3,optau,1);
    figure(1)
